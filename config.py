...
PUSH_TOKEN = 'edb956c697a04268b851be438de4fb67'

'''
*********** 地图配置 ***********
获取地点信息,这里用的高德api,需要自己去高德开发者平台申请自己的key
'''
#AMAP_KEY = os.environ.get("bef9cbb9d786f89cf73fff347373ee7b")
AMAP_KEY = '2068c9b7f292c679e7bf3882bcac3403'
