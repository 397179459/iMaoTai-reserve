...
'''
MT_PUSHPLUS_KEY = os.environ.get("MT_PUSHPLUS_KEY")
...
'''
MT_GAODE_KEY = os.environ.get("MT_GAODE_KEY")
...
'''
MT_PRIVATE_AES_KEY = os.environ.get("MT_PRIVATE_AES_KEY")
...
*********** 通过Webhook方式发送钉钉通知 ***********
1.在钉钉上创建一个群
2.添加一个机器人，webhook链接上可以找到 access_token
3.安全设置选择加签，可以获得secret_key
'''
MT_DINGTALK_ACCESS_TOKEN = os.environ.get("MT_DINGTALK_ACCESS_TOKEN")
MT_DINGTALK_SECRET = os.environ.get("MT_DINGTALK_SECRET")
